...
Make a random bucket name with `random_string()` from `sixtyfour`:
...
#> [1] "http://egs-xvrsghta.s3.amazonaws.com/"
```
...
#>  1 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:29 STANDARD    
#>  2 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:30 STANDARD    
#>  3 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:30 STANDARD    
#>  4 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:30 STANDARD    
#>  5 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:30 STANDARD    
#>  6 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:31 STANDARD    
#>  7 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:31 STANDARD    
#>  8 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:31 STANDARD    
#>  9 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:32 STANDARD    
#> 10 egs-xvrsghta file81… s3:/… 1.74K file  "\"6… 2025-01-10 19:15:32 STANDARD
```
...
#> [1] "http://egs-jfvsikzx.s3.amazonaws.com/"
```
...
#> [1] "s3://egs-jfvsikzx/file817471ff6764.txt"
#> [2] "s3://egs-jfvsikzx/file817436dd10b4.txt"
#> [3] "s3://egs-jfvsikzx/file81746b73b58f.txt"
```
...
#>   bucket       key      uri    size type  etag  lastmodified        storageclass
#>   <glue>       <chr>    <glu> <fs:> <chr> <chr> <dttm>              <chr>       
#> 1 egs-jfvsikzx file817… s3:/…    53 file  "\"a… 2025-01-10 19:15:36 STANDARD    
#> 2 egs-jfvsikzx file817… s3:/…    53 file  "\"a… 2025-01-10 19:15:36 STANDARD    
#> 3 egs-jfvsikzx file817… s3:/…    53 file  "\"a… 2025-01-10 19:15:35 STANDARD
```
...
#> 1 egs-jfvsikzx file81… s3:/…    53 file  "\"a… 2025-01-10 19:15:35 NA           
#> 2 egs-jfvsikzx file81… s3:/…    53 file  "\"a… 2025-01-10 19:15:36 NA           
#> 3 egs-jfvsikzx file81… s3:/…    53 file  "\"a… 2025-01-10 19:15:36 NA           
...
``` r
new_bucket <- random_string("egs-")
aws_bucket_create(new_bucket)
#> [1] "http://egs-tsbcdvhg.s3.amazonaws.com/"

# add existing files to the new bucket
aws_file_copy(remote_files, new_bucket)
#> [1] "s3://egs-tsbcdvhg/file817471ff6764.txt"
#> [2] "s3://egs-tsbcdvhg/file817436dd10b4.txt"
#> [3] "s3://egs-tsbcdvhg/file81746b73b58f.txt"

# create bucket that doesn't exist yet
# the force=TRUE makes this work non-interactively
another_bucket <- random_string("egs-")
aws_file_copy(remote_files, another_bucket, force = TRUE)
#> [1] "s3://egs-wuozsfjt/file817471ff6764.txt"
#> [2] "s3://egs-wuozsfjt/file817436dd10b4.txt"
#> [3] "s3://egs-wuozsfjt/file81746b73b58f.txt"
```
...
#> [1] "/var/folders/qt/fzq1m_bj2yb_7b2jz57s9q7c0000gp/T//RtmplCZ06h/file817477e2ae84"
readLines(tfile)
...
#> [1] "http://egs-gciavhtw.s3.amazonaws.com/"
...
#> 1 SensedForgivenes AIDA22PL… /     arn:… 2025-01-10 19:15:46 NA
...
#> ✔ SensedForgivenes now has read access to bucket egs-gciavhtw

# cleanup
six_user_delete(user)
#> ℹ Policy S3ReadOnlyAccessEgsGciavhtw detached
#> ! No access keys found for SensedForgivenes
#> ℹ SensedForgivenes deleted
...
#> [1] "s3://egs-ozrpxeyh/demo.rds"

## many files at once
links_file <- file.path(system.file(), "Meta/links.rds")
six_file_upload(c(demo_rds_file, links_file), bucket)
#> [1] "s3://egs-ozrpxeyh/demo.rds"  "s3://egs-ozrpxeyh/links.rds"
...
#> s3://egs-ozrpxeyh/demo.rds
#> s3://egs-ozrpxeyh/links.rds
aws_bucket_delete(bucket, force = TRUE)
```
