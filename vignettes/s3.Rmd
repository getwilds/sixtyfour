...
#> [1] "http://bucket-hbmkfxwpdnoilrts.s3.amazonaws.com/"
```
...
#>  1 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:20 STANDARD    
#>  2 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:20 STANDARD    
#>  3 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD    
#>  4 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD    
#>  5 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD    
#>  6 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD    
#>  7 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD    
#>  8 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD    
#>  9 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD    
#> 10 bucket-hbmkfx… file… s3:/… 1.74K file  "\"6… 2025-03-12 21:32:21 STANDARD
```
...
#> [1] "http://bucket-ymaozqbhlvdiwpce.s3.amazonaws.com/"
```
...
#> [1] "s3://bucket-ymaozqbhlvdiwpce/file111ba2ba0b6a1.txt"
#> [2] "s3://bucket-ymaozqbhlvdiwpce/file111ba44361a67.txt"
#> [3] "s3://bucket-ymaozqbhlvdiwpce/file111ba3bff832d.txt"
```
...
#>   bucket          key   uri    size type  etag  lastmodified        storageclass
#>   <glue>          <chr> <glu> <fs:> <chr> <chr> <dttm>              <chr>       
#> 1 bucket-ymaozqb… file… s3:/…    53 file  "\"a… 2025-03-12 21:32:23 STANDARD    
#> 2 bucket-ymaozqb… file… s3:/…    53 file  "\"a… 2025-03-12 21:32:23 STANDARD    
#> 3 bucket-ymaozqb… file… s3:/…    53 file  "\"a… 2025-03-12 21:32:23 STANDARD
```
...
#> 1 bucket-ymaozq… file… s3:/…    53 file  "\"a… 2025-03-12 21:32:23 NA           
#> 2 bucket-ymaozq… file… s3:/…    53 file  "\"a… 2025-03-12 21:32:23 NA           
#> 3 bucket-ymaozq… file… s3:/…    53 file  "\"a… 2025-03-12 21:32:23 NA           
#> # ℹ 31 more variables: accept_ranges <chr>, expiration <chr>, restore <chr>,
...
#> #   expires <dttm>, expires_string <chr>, website_redirect_location <chr>,
...
#> [1] "http://bucket-hizdwfnkjpcrqugs.s3.amazonaws.com/"

# add existing files to the new bucket
aws_file_copy(remote_files, new_bucket)
#> [1] "s3://bucket-hizdwfnkjpcrqugs/file111ba2ba0b6a1.txt"
#> [2] "s3://bucket-hizdwfnkjpcrqugs/file111ba44361a67.txt"
#> [3] "s3://bucket-hizdwfnkjpcrqugs/file111ba3bff832d.txt"
...
#> [1] "s3://bucket-pcbzdwktujoifmrg/file111ba2ba0b6a1.txt"
#> [2] "s3://bucket-pcbzdwktujoifmrg/file111ba44361a67.txt"
#> [3] "s3://bucket-pcbzdwktujoifmrg/file111ba3bff832d.txt"
```
...
#> [1] "/var/folders/qt/fzq1m_bj2yb_7b2jz57s9q7c0000gp/T//RtmpR9Kq1f/file111ba4f790260"
readLines(tfile)
...
#> [1] "s3://bucket-ymaozqbhlvdiwpce/myfile.txt"
aws_file_exists(remote_files[1])
#> [1] FALSE
```
...
#> [1] "http://bucket-qpgzdesoctbxhvar.s3.amazonaws.com/"
...
#> 1 FellowAnkle AIDA22PL7JXXR… /     arn:… 2025-03-12 21:32:28 NA
...
#> ✔ FellowAnkle now has read access to bucket bucket-qpgzdesoctbxhvar

# cleanup
six_user_delete(user)
#> ℹ Policy S3ReadOnlyAccessBucketqpgzdesoctbxhvar detached
#> ! No access keys found for FellowAnkle
#> ℹ FellowAnkle deleted
...
#> [1] "s3://bucket-jazdrlchemykqxsv/demo.rds"

## many files at once
links_file <- file.path(system.file(), "Meta/links.rds")
six_file_upload(c(demo_rds_file, links_file), bucket)
#> [1] "s3://bucket-jazdrlchemykqxsv/demo.rds" 
#> [2] "s3://bucket-jazdrlchemykqxsv/links.rds"
...
#> s3://bucket-jazdrlchemykqxsv/demo.rds
#> s3://bucket-jazdrlchemykqxsv/links.rds
aws_bucket_delete(bucket, force = TRUE)
```
