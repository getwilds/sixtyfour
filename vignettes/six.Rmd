...
dir_tree(tdir)
#> /var/folders/qt/fzq1m_bj2yb_7b2jz57s9q7c0000gp/T/Rtmp29dr9A/mytmp
#> ├── a
#> ├── b
#> ├── c
#> ├── d
...
Upload both the file and the directory of files to `bucket1`: bucket-xtdvfuhpnckqziyj
...
```
#>  [1] "s3://bucket-xtdvfuhpnckqziyj/demo.rds"
#>  [2] "s3://bucket-xtdvfuhpnckqziyj/mytmp/a" 
#>  [3] "s3://bucket-xtdvfuhpnckqziyj/mytmp/b" 
#>  [4] "s3://bucket-xtdvfuhpnckqziyj/mytmp/c" 
#>  [5] "s3://bucket-xtdvfuhpnckqziyj/mytmp/d" 
#>  [6] "s3://bucket-xtdvfuhpnckqziyj/mytmp/e" 
#>  [7] "s3://bucket-xtdvfuhpnckqziyj/mytmp/f" 
#>  [8] "s3://bucket-xtdvfuhpnckqziyj/mytmp/g" 
#>  [9] "s3://bucket-xtdvfuhpnckqziyj/mytmp/h" 
#> [10] "s3://bucket-xtdvfuhpnckqziyj/mytmp/i" 
#> [11] "s3://bucket-xtdvfuhpnckqziyj/mytmp/j" 
#> [12] "s3://bucket-xtdvfuhpnckqziyj/mytmp/k" 
#> [13] "s3://bucket-xtdvfuhpnckqziyj/mytmp/l" 
#> [14] "s3://bucket-xtdvfuhpnckqziyj/mytmp/m"
```
...
```
#> [1] "s3://bucket-xtdvfuhpnckqziyj/links.rds"
```
...
#> 1 UntimelyStandpoi AIDA22PL… /     ***** 2025-03-12 21:49:39 NA
```
...
#> ✔ UntimelyStandpoi now has read access to bucket bucket-xtdvfuhpnckqziyj
```
...
#>   <chr>            <chr>       <chr>                                <chr>       
#> 1 UntimelyStandpoi read        S3ReadOnlyAccessBucketxtdvfuhpnckqz… <NA>
```
...
#> ✔ UntimelyStandpoi now has write access to bucket bucket-xtdvfuhpnckqziyj
```
...
#>   <chr>            <chr>       <chr>                              <chr>       
#> 1 UntimelyStandpoi write       S3FullAccessBucketxtdvfuhpnckqziyj <NA>
```
...
#> ✔ UntimelyStandpoi access to bucket-xtdvfuhpnckqziyj has been removed
```
...
#> [1] "http://bucket-zgxwcbvjaohfspyt.s3.amazonaws.com/"
demo_rds_file <- file.path(system.file(), "Meta/demo.rds")
links_file <- file.path(system.file(), "Meta/links.rds")
aws_file_upload(
...
#> [1] "s3://bucket-zgxwcbvjaohfspyt/demo.rds" 
#> [2] "s3://bucket-zgxwcbvjaohfspyt/links.rds"
aws_bucket_list_objects(bucket2)
#> # A tibble: 2 × 8
#>   bucket         key   uri     size type  etag  lastmodified        storageclass
#>   <glue>         <chr> <glu> <fs::> <chr> <chr> <dttm>              <chr>       
#> 1 bucket-zgxwcb… demo… s3:/…    256 file  "\"7… 2025-03-12 21:50:14 STANDARD    
#> 2 bucket-zgxwcb… link… s3:/…  13.2K file  "\"0… 2025-03-12 21:50:14 STANDARD
```
...
```
#> ℹ deleting bucket bucket-zgxwcbvjaohfspyt
```
...
```
#> ℹ Added policy UserInfo to EmergencyAdverti
#> ✔ Key pair created for EmergencyAdverti
#> ℹ AccessKeyId: *****
#> ℹ SecretAccessKey: *****
```
