...
#> ℹ Added policy UserInfo to DreadOutset
#> ✔ Key pair created for DreadOutset
#> ℹ AccessKeyId: *****
#> ℹ SecretAccessKey: *****
...
#> ℹ Added policy UserInfo to NegativePlaza
#> ✔ Key pair created for NegativePlaza
#> ℹ AccessKeyId: *****
#> ℹ SecretAccessKey: *****
#> ℹ Added policy UserInfo to PreparatoryOrien
#> ✔ Key pair created for PreparatoryOrien
#> ℹ AccessKeyId: *****
#> ℹ SecretAccessKey: *****
#> ℹ Added policy UserInfo to SubjugatedStamin
#> ✔ Key pair created for SubjugatedStamin
#> ℹ AccessKeyId: *****
#> ℹ SecretAccessKey: *****
...
#> ℹ Added policy UserInfo to RemorselessTende
#> ✔ Key pair created for RemorselessTende
#> ℹ AccessKeyId: *****
#> ℹ SecretAccessKey: *****
```
...
#> [1] "s3://bucket-mlbsjyetvxcgzind/demo.rds"
```
...
#> Error: AccessDenied (HTTP 403). User: arn:aws:iam::*****:user/RemorselessTende is not authorized to perform: s3:ListBucket on resource: "arn:aws:s3:::bucket-mlbsjyetvxcgzind" because no identity-based policy allows the s3:ListBucket action
```

User RemorselessTende does not have access (read or write), as intended.
...
#> 1 bucket-mlbsjye… demo… s3:/…   254 file  "\"0… 2025-03-12 21:33:39 STANDARD
```
...
#> ℹ In index: 1.
#> Caused by error:
#> ! AccessDenied (HTTP 403). User: arn:aws:iam::*****:user/NegativePlaza is not authorized to perform: s3:PutObject on resource: "arn:aws:s3:::bucket-mlbsjyetvxcgzind/links.rds" because no identity-based policy allows the s3:PutObject action
```

User NegativePlaza does have access for read and NOT for write, as intended.
...
#> [1] "s3://bucket-mlbsjyetvxcgzind/links.rds"
```

User DreadOutset DOES have access for read and write, as intended.
