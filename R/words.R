adjectives <- c(
  ...
  "cosmic", "cover", "crash",
  "culminate", "cushioned", "dandy", "dashing",
  ...
  "goalless", "goody", "grammatical", "grande",
  "grateful", "gratuitous", "graven", "greener", "grinding",
  "grizzly", "groaning", "grudging", "guaranteed", "gusty",
  "gypsy", "handheld",
  "harlot", "healing", "healthier", "healthiest",
  "heart", "heathen", "hedonistic", "heralded",
  ...
  "pliable", "plumb", "politician", "polygamous",
  ...
  "testimonial", "thicker", "threatening",
  ...
  "tyrannical", "unaided", "unassisted", "unassuming",
  ...
  "visual", "voluptuous", "wanton", "warlike",
  "washed", "waterproof", "waved", "weakest",
  "wetting", "wheeled", "whirlwind",
...
nouns <- c(
  ...
  "consistency", "consolidation", "conspiracy", "constable",
  ...
  "crossover", "crossroads", "culprit", "cumin",
  ...
  "denomination", "dentist", "departure", "depletion",
  "designation", "despotism", "detention", "developer",
  ...
  "espionage", "estimation", "evacuation", "exaggeration",
  ...
  "iniquity", "innocence", "innovation", "inspiration",
