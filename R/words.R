adjectives <- c(
  ...
  "autobiographical", "avaricious", "avocado", "awake",
  "backstage", "backwoods", "balding", "bandaged",
  "banded", "banned", "barreled", "battle", "beaten",
  "begotten", "beguiled", "bellied", "belted",
  "besieged", "betting", "biggest", "biochemical",
  "blackened", "blame",
  "bloat", "blocked", "blooded", "blushing",
  ...
  "candied", "canonical", "cantankerous",
  "carefree", "caretaker", "casual", "cathartic", "causal",
  "chapel", "characterized", "charcoal", "cheeky", "cherished",
  "chipotle", "chirping", "circumstantial", "civic",
  "civil", "civilised", "clanking", "clapping",
  "classless", "cleansed", "cloistered", "codified",
  "colloquial", "colour", "combat", "combined",
  ...
  "confuse", "congressional", "consequential", "constituent",
  "contaminated", "contemporaneous", "convertible", "convex",
  ...
  "designing", "despairing", "destitute", "detective",
  "determined", "devastating",
  "diagonal", "dictated", "didactic", "differentiated",
  "diffused", "dirtier", "disconnected", "discovered",
  "disdainful", "diseased", "disheartened", "disheveled",
  "disillusioned", "disparate", "dissident", "doable", "doctrinal",
  "doing", "dotted", "downbeat", "dozen",
  ...
  "evaporated", "evergreen", "everlasting", "exacting",
  ...
  "fainter", "fallacious", "faltering", "famous",
  "fancier", "fated", "favourable", "fearless",
  ...
  "insensible", "insidious", "insincere",
  "insistent", "insolent", "insufferable", "intemperate", "interdependent",
  "interesting", "interfering", "intern", "interpreted", "intersecting",
  "intuitive", "irresolute", "irritate",
  "jerking", "joining", "joint",
  "journalistic", "joyful", "keyed", "knowing", "lacklustre",
  "laden", "lagging", "lamented", "laughable", "layered",
  "leather", "leathern", "leery", "legible",
  "leisure", "lessening", "liberating", "lifted",
  "lightest", "limitless", "listening", "literary", "liver",
  "livid", "lobster", "locked", "loudest",
  "lowering", "lucid", "luckless",
  "luxurious", "magazine", "maniac", "maroon",
  "mastered", "material", "materialistic", "meaningful",
  ...
  "motley", "motorized", "mounted", "multidisciplinary",
  "muted", "mysterious", "mythic",
  "natural", "nauseous", "negative", "networked",
  "neurological", "neutered", "newest", "night", "nitrous",
  "noncommercial", "nonsense", "north", "nuanced",
  "occurring", "offensive", "oldest", "oncoming",
  "onstage", "onward", "opaque",
  "operating", "opportunist", "opposing", "ordinate",
  "outdone", "outlaw", "outsized", "overboard", "overheated",
  "oversize", "overworked", "oyster", "paced", "panting",
  "paramount", "parental", "parted", "partisan",
  "passive", "pastel", "peacekeeping", "pedestrian",
  "peevish", "penned", "pensive", "perceptual",
  "perky", "permissible", "pernicious", "perpetuate", "perplexed",
  "pervasive", "philosophical", "picturesque",
  "pillaged", "piped", "piquant", "pitching", "plausible",
  "pliable", "plumb", "politician",
  "portmanteau", "posed", "positive", "possible",
  "postpartum", "prank", "precocious", "predicted",
  "premium", "preparatory", "prerequisite", "prescient", "preserved",
  "presidential", "pressed", "pressurized", "presumed",
  "priced", "pricier", "primal", "primer", "primetime",
  "printed", "private", "problem", "procedural",
  "process", "prodigious", "professional", "programmed", "progressive",
  "prolific", "promising", "promulgated", "pronged", "proportionate",
  "protracted", "pulled", "pulsed", "quick",
  ...
  "ringed", "risque", "robust", "roomful",
  "rotating", "roused", "rubber", "running",
  ...
  "scratchy", "scrolled", "seated",
  "semiautomatic", "senior", "sensed", "sentient",
  "shadowy", "shaken", "shaker", "shameless",
  "shaped", "shiny", "shipped", "shivering", "shoestring",
  "short", "signed", "simplest", "simplistic",
  "sizable", "skeleton", "skirting", "skyrocketed",
  "slamming", "slanting", "slapstick", "sleek", "sleepless",
  "sleepy", "slender", "slimmer", "smacking", "smokeless",
  "smothered", "smouldering", "snuff", "socialized",
  "sometime", "sought", "sparing", "spattered",
  "specialized", "specific", "speedy", "spherical", "spiky",
  "sprung", "squint", "stainless", "standing",
  "starlight", "startled", "stately", "statewide", "stereoscopic",
  "sticky", "stoked", "stolen",
  "storied", "strained", "strengthened", "stubborn",
  "stylized", "subjective", "subjugated",
  "succeeding", "summary", "sunset", "sunshine",
  "supernatural", "supervisory", "surrogate", "suspended",
  ...
  "testimonial", "thicker",
  "timed", "timely", "timid", "torrent",
  "totalled", "tougher", "traditional", "transformed",
  "trapped", "traveled", "traverse", "treated",
  "trial", "trunk", "trusting", "trying", "twisted",
  "unaided", "unassisted", "unassuming",
  "uncapped", "uncomfortable", "uncontrolled", "uncooked",
  "underground", "undersea", "undisturbed", "unearthly",
...
nouns <- c(
  ...
  "allotment", "ammonia", "anatomy",
  "ankle", "announcement", "annoyance", "annuity",
  "anomaly", "anthropology", "anxiety", "apologise",
  "apparatus", "appendix",
  ...
  "auspices", "authority", "aversion", "aviation",
  "babbling", "backlash", "baker", "ballet",
  ...
  "buyout", "cabal", "cabbage",
  "calamity", "campaign", "canonization", "captaincy",
  "carrier", "cartridge", "cassette", "catfish", "caught",
  "celebrity", "cemetery", "certainty", "certification", "charade",
  "chasm", "cheerleader", "cheesecake",
  "chili", "chivalry", "cilantro",
  ...
  "commander", "commemoration", "commenter", "commissioner",
  "competition", "completeness", "complexity", "computing",
  "concur", "condominium", "conduit", "confidant",
  "configuration", "conflagration", "conflict", "consist",
  "consistency", "consolidation", "constable",
  "consultancy", "contentment", "contents", "contractor", "conversation",
  "cornerstone", "corpus", "correlation", "counselor",
  "countdown", "coverage", "covering", "coyote",
  "cracker", "criminality", "crocodile", "cropping",
  "crossover", "crossroads", "cumin",
  "curator", "curfew", "cursor", "custard", "cutter",
  "cyclist", "cyclone", "cylinder", "cynicism",
  "darkness", "dawning", "daybreak", "dealing",
  "dedication", "deduction", "defection", "deference", "deficiency",
  "definition", "deflation", "degeneration", "delegation", "delicacy",
  "delirium", "demeanor", "demonstration",
  "dentist", "departure", "depletion",
  "designation", "detention", "developer",
  "dexterity", "diagnosis", "dialect", "differentiation",
  "digress", "dioxide", "diploma",
  "discord", "discovery", "dismissal",
  "dispatcher", "disservice", "distribution", "distributor", "diver",
  "diversity", "docking", "dollar",
  "dominion", "donkey", "doorstep", "doorway",
  "downside", "drafting", "drilling", "driver",
  "drumming", "duchess", "ducking", "dugout",
  ...
  "envoy", "equation", "equator", "error",
  "estimation", "evacuation", "exaggeration",
  "examination", "exclamation", "expediency", "exploitation", "extinction",
  "eyewitness", "falls", "fastball",
  "feedback", "ferocity", "fertilization", "finale",
  ...
  "futility", "gallantry", "gallery", "genesis",
  "glitter", "glucose", "google",
  "grandeur", "grappling", "greens", "gridlock", "grocer",
  "groundwork", "grouping", "gusto", "habitation",
  ...
  "helper", "helping", "hierarchy", "hoarding",
  "hockey", "homeland", "homer", "honesty",
  "horseman", "hostility", "housing", "humility", "hurricane",
  "iceberg", "ignition", "illness", "illustration",
  "illustrator", "immunity", "immunization",
  "inaccuracy", "inaction", "inactivity", "inauguration",
  "indicator", "inevitability", "infamy", "infiltration", "influx",
  "innocence", "innovation", "inspiration",
  "instruction", "instructor", "insurer", "interact", "intercession",
  "intermission", "interpretation", "intersection", "interval",
  "invasion", "investment", "involvement",
  "irrigation", "iteration", "jogging",
  "juggernaut", "juncture", "jurisprudence",
  "juror", "kangaroo", "kingdom", "knocking", "laborer",
  "laurels", "layout", "leadership", "leasing",
  "legislation", "leopard", "liberation", "licence", "lifeblood",
  "lifeline", "ligament", "lighting", "likeness",
  "lineage", "liner", "lineup", "liquidation", "listener",
  "literature", "litigation", "litre", "loathing", "locality",
  "lodging", "logic", "longevity", "lookout",
  "lustre", "machinery", "madness", "magnificence",
  "mahogany", "mailing", "mainframe", "maintenance", "majority",
  "mango", "manifesto", "mantra", "manufacturer",
  ...
  "operation", "opportunity", "opposition", "oracle",
  ...
  "pathos", "pendulum", "penguin", "permission",
  "persona", "perusal", "pessimism", "philosopher",
  "phosphorus", "phrasing", "piles", "plateau",
  "playing", "plaza", "plethora", "plurality", "pneumonia",
  "pointer", "poker", "policeman", "polling",
  "poster", "posterity", "posting", "postponement", "potassium",
  "pottery", "poultry", "pounding", "pragmatism", "precedence",
  "precinct", "preoccupation", "pretense",
  "proceeding", "proceedings", "processing",
  "processor", "progression", "projection", "prominence", "propensity",
  "prophecy", "prorogation", "prospectus", "protein", "prototype",
  "providence", "provider", "provocation", "proximity",
  "publicist", "publicity", "publisher", "pundit", "putting",
  "quantity", "quart", "quilting", "quorum",
  "radiance", "ralph", "rancher", "ranger", "rapidity",
  "rapport", "ratification", "rationality", "reaction", "reader",
  "reassurance", "receptor", "recipe", "recognition",
  "recourse", "rector", "recurrence",
  "redistribution", "redundancy", "refinery", "reformer", "refrigerator",
  "regularity", "regulator", "reinforcement", "reinstatement",
  "relativism", "relaxation", "repayment",
  "repertoire", "repository", "republic", "reputation",
  "residency", "resignation", "restaurant", "resurgence", "retailer",
  "retention", "retirement", "reviewer", "riches",
  "roadblock", "robber", "rocks", "runoff",
  "sarcasm", "saucer",
  "scarcity", "scenario", "scenery", "schism", "scholarship",
  "schooner", "scissors", "scolding", "scooter",
  "scouring", "scrimmage", "scrum", "seating", "sediment",
  "semicolon", "semiconductor", "semifinal", "senator",
  "sending", "serenity", "seriousness", "sesame",
  ...
  "tendency", "tendon", "terrier",
  "theater", "thicket", "thoroughfare",
  "threshold", "thriller", "thunderstorm", "ticker", "tiger",
  "tights", "tossing", "touchdown", "tourist",
  "tourney", "tracing", "tractor", "translation",
  "transmission", "transmitter", "traveler", "treadmill",
  "trilogy", "trout", "tuning", "twenties",
  "tycoon", "ultimatum", "underdog",
  "unhappiness", "unification", "university", "uprising",
  ...
  "vogue", "volcano", "voltage", "vulnerability",
  "waistcoat", "waitress", "wardrobe", "warmth", "watchdog",
  "wealth", "weariness", "whereabouts",
  "widget", "width", "windfall", "wiring",
  "withholding", "words", "workman"
)
